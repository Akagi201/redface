...
func writeTo(w io.Writer, buf []byte, m interface{}, forceString, noArrayHeader bool) (int64, error) {
	switch mt := m.(type) {
	case []byte:
...
func writeErr(w io.Writer, buf []byte, ierr error, forceString bool) (int64, error) {
...
func writeInt(w io.Writer, buf []byte, i int64, forceString bool) (int64, error) {
